...
class TrimprogressPainter extends CustomPainter {
  const TrimprogressPainter(
      this.rect,
      this.position,
      this.style, {
  ...
  @override
  bool shouldRepaint(TrimprogressPainter oldDelegate) =>
  ...
  @override
  bool shouldRebuildSemantics(TrimprogressPainter oldDelegate) => false;
}
